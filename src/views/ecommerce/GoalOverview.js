...
const GoalOverview = props => {
  ...
  return  (
    <Card>
      <CardHeader>
        <CardTitle tag='h4'>درصد دوره های فعال</CardTitle>
      ...
      <Row className='border-top text-center mx-0'>
        <Col xs='6' className='border-end py-1'>
          <CardText className='text-muted mb-0'>فعال</CardText>
          <h3 className='fw-bolder mb-0'>
            1000
          </h3>
        </Col>
        <Col xs='6' className='py-1'>
          <CardText className='text-muted mb-0'>غیرفعال</CardText>
          <h3 className='fw-bolder mb-0'>200</h3>
        </Col>
      </Row>
    </Card>
  ) 
